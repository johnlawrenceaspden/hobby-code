/*
 *  Tespar20kHzCodebookWithSilenceSymbol.java
 */
 ...
 * Symbol 29 is for those which either go off the scale in terms of duration or have excessive shape given their duration.
 */
public class Tespar20kHzCodebook implements Codebook {
  int silenceThreshold;
  private static final int SILENCE=0;
  private static final int OUTSIDECODEBOOK=29;

  /** Creates new TESPAR20kHzCodebookWithSilenceSymbol.
 * @param silenceThreshold The smallest magnitude epoch which is not to be considered as silence.
 */
  public Tespar20kHzCodebook(int silenceThreshold) {
    this.silenceThreshold=silenceThreshold;
  }
  
  public String getName()
  {
    return "Tespar 20kHz Codebook with Silence Symbol (Silence Threshold "+this.silenceThreshold+" )";
  }

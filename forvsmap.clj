...
;; The consequences of map taking many possible arguments were not
;; clear to me until I realized that it's 'side by side' iteration.
...
;; And I think most people will find the first one easier to read
...
;; And so I had a sort of feeling that list comprehension and
;; map/filter were equivalent but that list comprehensions were
;; somewhat easier to read.

;; This certainly seems to be the case in python, where there have
;; been occasional attempts to take map filter and reduce out of the
;; language, in favour of list comprehensions
...
;; Or maybe I just don't know the syntax for side by side
;; iteration. Or even the proper name. The earlier combination is
;; called 'cartesian product', and I am tempted to call the latter one
...
;; Thank you to Alex Stoddard for that!

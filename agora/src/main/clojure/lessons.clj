...
(def title1 "Bishop Barrington School: Art Department Scheme of Work")

(def title2 "Jon Burgerman - Level 5 to Level 6")
...
(def grid '((
             ...
             "Pupils look at the cultural context of Burgerman’s work and develop an understanding of the place it has in contemporary art. They view and discuss work created by Burgerman’s peers and comment no the type of people it would appeal to."
             "Context Contemporary Style Function Influence Use Purpose"
             "Pupils create a page in their sketchbook looking at the meaning of context and res earching the work of Burgerman’s peers. They include notes that communicate their own personal response to the work. "
             "Pupils write own success criteria in lesson after looking at example book."
             )(
             ...
             "Technique Process Media Material Evaluation Health & Safety"
             ...
             "Style Loose Distinctive Influence Process Media Technique Enlarge Develop"
             ...
             "Pupils write their own success criteria based on the surface they are using."
             )(
             ...
             "Pupils ask Jon to make notes in their sketchbooks and take photos of him at work. They produce a page in their book documenting the day and detailing their experience. "
...
(defn subartist [fname sname s]
  (re-gsub #"Jon" fname
           (re-gsub #"Burgerman" sname
                    s)))

(defn subgrid [fname sname grid]
  (map (fn[lst] (map (fn[y] (subartist fname sname y)) lst)) grid))


(defn lessonplan [[fname sname]]
     (html
      [:head
       [:title (subartist fname sname title1)]]
      [:body
       [:h1 (subartist fname sname title2)]
       [:table {:border 1}
        (stringss->table (subgrid fname sname grid))
        ]]))

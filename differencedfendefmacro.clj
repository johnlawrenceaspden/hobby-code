;; Once upon a time, the question "What is the difference between defn and defmacro came up on Stack Overflow.
...
C also has macros, which work the same way, but they're always going wrong, and to get them right you need to put so many brackets into your program that it looks like LISP!

...
(println "time for longest update operation")
(time (update-val vzero  [max-cars,max-cars]))   ; 69.99999997645457 ; 69.99999997645457
(time (nupdate-val vzero [max-cars,max-cars] 0)) ; 59.99999999972748 ; 69.99999997645457
...
(ps 40 (for [v nvseries-sor] (v [0,19]))) ; (0 45.0 88.35 130.1 170.33 209.08 246.4 282.35 316.99 350.35 382.49 413.45 443.27 472.0 499.67 526.33 552.01 576.74 600.57 623.52) ; (0 60.0 117.06 171.33 222.95 272.03 318.72 363.12 405.34 445.5 483.7 520.02 554.57 587.42 618.67 648.39 676.65 703.53 729.09 753.41)

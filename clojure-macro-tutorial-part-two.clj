...
;; WARNING! The first bit of this tutorial was about the idea of using the
;; compiler itself to write code.  This joyful idea has a slightly chequered
;; history, and turned out to be every bit as hard to get right as the idea of a
;; subroutine was.
